...
function init(){
    ...
    // Store sentiment slider's current value in localStorage
    sentimentSlider.addEventListener('input', saveSentimentForCurrSliderVal);
...
/**
 * Save sentiment for current date
 */
...
function updateFaceIcon(value) {
    ...
    if (value <= 20) {
        ...
        faceIcon.src = "../img/sad_face.png";
    } else if(value <= 60){
        faceIcon.src = "../img/soso_face.png"; 
    } else if(value <= 80){
        faceIcon.src = "../img/happy_face.png"; 
    } else {
        faceIcon.src = "../img/laughing_face.png"; 
    }
}

/**
 * Save the sentiment for current slider value
 */
function saveSentimentForCurrSliderVal() {
